...
const Cart:FunctionComponent<Props> = ({addToCart,cartItems,removeFromCart}) => {
  ...
  return (
    <div className="w-[500px] p-5">
      ...
      {cartItems.map(item =>(
        <CartItems item={item} key={item.id} addToCart={addToCart} removeFromCart={removeFromCart}/>
      ))}
